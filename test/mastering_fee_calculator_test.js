describe('Calculator', function(){
    ...
    it('with stem mastering', function () {
      ...
      assert.equal(12 + 35, compute(inputs));
    });
    it('with stem mastering with 2 songs', function () {
        ...
        assert.equal(12*2 + 35*2, compute(inputs));
    });
    it('with stem mastering with 7 songs', function () {
        ...
        assert.equal(12*7 + 210, compute(inputs));
    });
    ...
    it('with extra loud with 14 songs', function () {
        ...
        assert.equal(12*14 + 387.70, compute(inputs));
    });
  it('with DDP coding', function () {
    ...
    assert.equal(30 + 35, compute(inputs));
  });
  it('with DDP coding and press delivery', function () {
      ...
      assert.equal(30 + 40 + 35, compute(inputs));
  });
  it('with postal sending', function () {
      ...
      assert.equal(15 + 35, compute(inputs));
  });
  it('with pbo instru', function () {
    ...
    assert.equal(35 + 12, compute(inputs));
  });
  it('with pbo instru and 7 songs', function () {
    ...
    assert.equal(30 * 7 + 12 * 7, compute(inputs));
  });
  it('with 1 song between 5 and 9 minutes give 35 + 35/2 = 52,5', function () {
    var inputs = new function () {
      this.songCount = {1: 1};
    };
    assert.equal(52.5, compute(inputs));
  });
